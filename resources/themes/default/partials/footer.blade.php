		...
		<div class="xs-footer-top-layer">
			<div class="row">
				<div class="col-lg-3 col-md-6 footer-widget xs-pr-20">
					...
					<h3 class="widget-title">Sahabat Inspirasi</h3>
					<p>Kami adalah komunitas sosial yang memiliki concern terhadap anak - anak,terutama anak yatim piatu dan kaum dhuafa.</p>
								...
								<div class="posts-thumb float-left"> 
									<a href="#">
										...
										<div class="xs-entry-date">
											...
											<span class="entry-month d-block">apr</span>
										</div>
							...
							<li>
								<div class="posts-thumb float-left"> 
									<a href="#">
										...
										<div class="xs-entry-date">
											<span class="entry-date d-block">17</span>
											<span class="entry-month d-block">Feb</span>
										</div>
										<div class="xs-black-overlay bg-aqua"></div>
									</a>
								</div><!-- .posts-thumb END -->
				...
				<div class="col-lg-4 col-md-6 footer-widget">
					...
					<ul class="xs-info-list">
						<li><i class="fa fa-home"></i>Jl. Sunter No. 53 Rt 10 Rw 001, Pulo gadung Jakrta Timur.</li>
						<li><i class="fa fa-phone"></i>+62 821-1120-0236</li>
						<li><i class="fa fa-envelope-o"></i><a href="mailto:sahabatinspirasiproject@gmail.com">sahabatinspirasiproject@gmail.com</a></li>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="xs-copyright-text">
						<p>&copy; Copyright 2018 <a href="#">Sahabat Inspirasi</a></p>
					</div>
				</div>
				<div class="col-md-6">
