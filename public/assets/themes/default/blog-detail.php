...
<html class="no-js" lang="en">
	<head>
		...
		<title>Charity Press - Blog Single</title>
	...
	<div class="container">
		<div class="color-white xs-inner-banner-content">
			...
			<ul class="xs-breadcumb">
				<li class="badge badge-pill badge-primary"><a href="index.html" class="color-white"> Home /</a> Details</li>
			</ul>
		</div>
	</div>
</section>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="xs-copyright-text">
								<p>&copy; Copyright 2017 <a href="https://themeforest.net/user/xpeedstudio/portfolio">XpeedStudio</a> - CharityPress WP Theme</p>
							</div>
						</div>
						<div class="col-md-6">
