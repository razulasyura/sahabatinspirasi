...
<section class="xs-banner-inner-section parallax-window" style="background-image:url('assets/images/backgrounds/gallery_bg.jpg')">
...
<main class="xs-main">
	...
	<div class="container">
		<div class="xs-portfolio-grid">
			...
			<div class="xs-portfolio-grid-item">
				<a href="assets/images/portfolio/gallery_7.jpg" class="xs-single-portfolio-item xs-image-popup">
			...
			<div class="xs-portfolio-grid-item">
				<a href="assets/images/portfolio/gallery_8.jpg" class="xs-single-portfolio-item xs-image-popup">
			...
			<div class="xs-portfolio-grid-item">
				<a href="assets/images/portfolio/gallery_9.jpg" class="xs-single-portfolio-item xs-image-popup">
